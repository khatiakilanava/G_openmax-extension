...
class encoder32(nn.Module):
    def __init__(self, latent_size=100, num_classes=10, batch_size=64):
...
class generator32(nn.Module):
    def __init__(self, latent_size=100, batch_size=64):
        super(self.__class__, self).__init__()
...
class multiclassDiscriminator32(nn.Module):   ## it's a patch discriminator
    def __init__(self, latent_size=100, num_classes=10, batch_size=64):
        super(self.__class__, self).__init__()
        self.batch_size = batch_size
        self.num_classes = num_classes
...
class classifier32(nn.Module):
    def __init__(self, latent_size=100, num_classes=2, batch_size=64):
        super(self.__class__, self).__init__()
        self.batch_size = batch_size
        self.num_classes = num_classes
        self.conv1 = nn.Conv2d(3,       64,     3, 1, 1, bias=False)
